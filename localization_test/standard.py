...
train_dataset_condition = 5
test_dataset_condition = 5
# DATASET_CONDITION = [
...
if train_dataset_condition != test_dataset_condition:
    test_data,test_label,_,_ = util.file_io.load_txt_files_in_dataset_conditions(
        config.file_io.DATASET_PARENT_PATH,
